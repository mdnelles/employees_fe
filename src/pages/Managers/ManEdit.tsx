...
export default function ManEdit(props: ManEditProps): JSX.Element {
   ...
   const managers: ManagersType = useAppSelector(
      (state: any) => state.managers
   );
   const manArr: any = managers.arr;
